...
from tzchat_tokenizer import tzchatTokenizer
...
def make_dataset():
    raw_dataset = tzchatDataset(args.output_path, args.seed, args.input_dataset_file)
    train_dataset = raw_dataset.get_train_data()
    tokenizer = tzchatTokenizer(args.vocab_file_path, fast_tokenizer=True,
